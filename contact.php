...
<html lang="en">
  ...
  <?php
	...
	?>
	<div class="body-text">
		<h1><?php echo callLocalisation($language, 25);?></h1>
	</div>
	<div>
		<p class="description-text"> <?php echo callLocalisation($language, 26);?>&nbsp;&nbsp; <a href="https://goo.gl/maps/ZKxDJDtkk9q3P3E58"> 50 Rue de Beggen, 1220 Luxembourg</a></p>
		<p class="description-text"> <?php echo callLocalisation($language, 27);?> &nbsp; <a href = "mailto:secretariat@lpem.lu"> <?php echo callLocalisation($language, 28);?></a></p>
		<p class="description-text"> <?php echo callLocalisation($language, 29);?>&nbsp; <a href="tel:123-456-7890">4390611</a></p>
	</div>
    <br>
    <div class="map">
