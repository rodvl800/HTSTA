...
<html lang="en">
  ...
  <body>
      ...
      <div class="AddProduct">
          <a href="AddProduct.php?page=AddProduct"><button class="AddToCartButton"><?php echo callLocalisation($language, 8);?></button></a>
      </div>
      <div class="body-text"><h1><?php echo callLocalisation($language, [9]);?></h1></div>
      <br>
